...
function calculateContractAddress(FactoryContract, IntermediateFactory, AccountAbstration) {
  ...
  for (salt=770000; salt<100000000; salt++){
...
async function main() {
  ...
  // const provider = new ethers.provider.JsonRpcProvider('http://127.0.0.1:8545/');
  ...
  const mainFactoryAddress = '0x0b58f6C7cA2743c5F75e2BEfB19f6951aDBb223f'
